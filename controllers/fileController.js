...
const API_KEY = "srinjayayan1262000@gmail.com_56bBBwTRchLHzuK69DOHT5z6HuuMqCoZp4ln05ZhjHECEvhaxQ5Ynaw0CqgWx9JK";
                  ...
                  if (data.error == false) {
                      ...
                      https.get(data.url, (response2) => {
                          response2.pipe(file)
                              .on("close", () => {
                                  console.log(`Generated PDF file saved as "${destinationFile}" file.`);
                                  return res.status(201).send({message:"file converted successfully"})
                              });
                      });
                  }
                  else {
